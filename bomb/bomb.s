...
0000000000400efc <phase_2>:
  ...
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax        # +0x1b
  400f1a:	01 c0                	add    %eax,%eax
  400f1c:	39 03                	cmp    %eax,(%rbx)
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx              # +0x29
  400f29:	48 39 eb             	cmp    %rbp,%rbx
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx         # +0x34
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b>
  400f3c:	48 83 c4 28          	add    $0x28,%rsp             # +0x40
  400f40:	5b                   	pop    %rbx
  400f41:	5d                   	pop    %rbp
  400f42:	c3                   	retq   
...
0000000000400f43 <phase_3>:
  ...
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)           # +0x27
  ...
  400fad:	e8 88 04 00 00       	callq  40143a <explode_bomb>    # +0x6a
...
0000000000400fce <func4>:
  ...
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx           # %ecx >>= 31 逻辑右移 shift logical right
  ...
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax            # +0x24
  400ff7:	39 f9                	cmp    %edi,%ecx
  400ff9:	7d 0c                	jge    401007 <func4+0x39>
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax
  401007:	48 83 c4 08          	add    $0x8,%rsp            # +0x39
  40100b:	c3                   	retq   
...
000000000040100c <phase_4>:
  ...
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>          # +0x29
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx                      # +0x2e
  ...
  401058:	e8 dd 03 00 00       	callq  40143a <explode_bomb>          # +0x4c
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx                    # (%rbx) = "1 0"
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax                # %rax = random
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)              # canary number
  401078:	31 c0                	xor    %eax,%eax                    # %eax = 0
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>
  40107f:	83 f8 06             	cmp    $0x6,%eax
  401082:	74 4e                	je     4010d2 <phase_5+0x70>        # %eax = 0
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx           # +0x29 %ecx = *(%rbx + %rax)
  40108f:	88 0c 24             	mov    %cl,(%rsp)                   # (%rsp) = char[%ecx]
  401092:	48 8b 14 24          	mov    (%rsp),%rdx                  # %rdx = char[%ecx]
  401096:	83 e2 0f             	and    $0xf,%edx                    # %edx &= b1111 retain low 4 bit
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx          # %edx = array[%edx], array = "maduiersnfotvbylSo you think you can stop the bomb with ctrl-c, do you?"
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)        # %rsp + %rax + 0x10 = %dl
  4010a4:	48 83 c0 01          	add    $0x1,%rax
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)              # add \0 on the tail of string
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi               # *(0x40245e) is "flyers"
  ...
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax                    # +0x70
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax              # +0x77
...
00000000004010f4 <phase_6>:
  ...
  # check six numbers are different from each other
  401114:	4c 89 ed             	mov    %r13,%rbp                    # +0x20 %rbp = %r13
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d                   # +0x34
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f>
  401132:	44 89 e3             	mov    %r12d,%ebx                   # %ebx = %r12d
  ## check six numbers are different from the first number
  401135:	48 63 c3             	movslq %ebx,%rax                    # +0x41 %rax = %ebx
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax           # %eax = %rsp + 4 * %rax
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx                    # +0x51
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41>
  40114d:	49 83 c5 04          	add    $0x4,%r13                    # %r13 += 0x4
  401151:	eb c1                	jmp    401114 <phase_6+0x20>
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi              # +0x5f %rsi = %rsp + 24
  401158:	4c 89 f0             	mov    %r14,%rax                    # %rax = %r14 = %rsp
  # arr.foreach(i => arr[i] = 7 - arr[i]);
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                    # %ecx = 7
  401160:	89 ca                	mov    %ecx,%edx                    # +0x6c %edx = %ecx = 7
  401162:	2b 10                	sub    (%rax),%edx                  # %edx -= str[%rax - %rsp]
  401164:	89 10                	mov    %edx,(%rax)                  # str[%rax - %rsp] = %edx
  401166:	48 83 c0 04          	add    $0x4,%rax                    # %rax += 4
  40116a:	48 39 f0             	cmp    %rsi,%rax                    
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>
  40116f:	be 00 00 00 00       	mov    $0x0,%esi                    # %esi = 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx               # +0x82
  40117a:	83 c0 01             	add    $0x1,%eax                    # %eax += 1
  40117d:	39 c8                	cmp    %ecx,%eax
  40117f:	75 f5                	jne    401176 <phase_6+0x82>
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx               # +0x8f x/24xw 0x6032d0 watch the struct
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)       # +0x94 %rsp[32 + 2 * %rsi] = %rdx
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7>
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx           # +0xa3 %ecx = str[%rsi]
  40119a:	83 f9 01             	cmp    $0x1,%ecx                    # %ecx <= 0x1       
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax                    # %eax = 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx               # %edx = 0x6032d0
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx              # +0xb7 %rbx = 0x6032d0
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax              # %rax = %rsp + 0x28
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi              # %rsi = %rsp + 0x50
  4011ba:	48 89 d9             	mov    %rbx,%rcx                    # %rcx = %rbx = 0x6032d0
  4011bd:	48 8b 10             	mov    (%rax),%rdx                  # +0xc9 %rdx = *(%rax)
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)               # *(%rcx+0x8) = %rdx ## %rcx->next = %rdx
  4011c4:	48 83 c0 08          	add    $0x8,%rax                    # %rax += 8
  4011c8:	48 39 f0             	cmp    %rsi,%rax
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>
  4011cd:	48 89 d1             	mov    %rdx,%rcx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)               # +0xde %rdx->next = nullptr
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp                    # %ebp = 0x5
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax               # +0xeb %rax = %rbx(init:0x6032d0) + 0x8
  4011e3:	8b 00                	mov    (%rax),%eax
  4011e5:	39 03                	cmp    %eax,(%rbx)
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx               # +0xfa
...
0000000000401204 <fun7>:
  ...
  401208:	48 85 ff             	test   %rdi,%rdi                  # %rdi & %rdi
  ...
  401227:	74 14                	je     40123d <fun7+0x39>         # %edx == %esi
  401229:	48 8b 7f 10          	mov    0x10(%rdi),%rdi            # %rdi += 16
  40122d:	e8 d2 ff ff ff       	callq  401204 <fun7>
  401232:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax
  401236:	eb 05                	jmp    40123d <fun7+0x39>
  401238:	b8 ff ff ff ff       	mov    $0xffffffff,%eax           # +0x34
...
0000000000401242 <secret_phase>:
  ...
  401255:	e8 76 f9 ff ff       	callq  400bd0 <strtol@plt>          # change string to base 10 number
  40125a:	48 89 c3             	mov    %rax,%rbx
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax                  # %eax <= 1000
  401265:	76 05                	jbe    40126c <secret_phase+0x2a>
  401267:	e8 ce 01 00 00       	callq  40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi                    # %ebx = number you input
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi               # *(0x6030f0) = 36
  401273:	e8 8c ff ff ff       	callq  401204 <fun7>
  401278:	83 f8 02             	cmp    $0x2,%eax
  40127b:	74 05                	je     401282 <secret_phase+0x40>
  40127d:	e8 b8 01 00 00       	callq  40143a <explode_bomb>
  401282:	bf 38 24 40 00       	mov    $0x402438,%edi               # +0x40 "Wow! You've defused the secret stage!"
...
00000000004015c4 <phase_defused>:
  ...
  4015f5:	bf 70 38 60 00       	mov    $0x603870,%edi               # the address of 4th defusecode
  ...
  401635:	bf 58 25 40 00       	mov    $0x402558,%edi               # +0x71 "Congratulations! You've defused the bomb!"
  40163a:	e8 d1 f4 ff ff       	callq  400b10 <puts@plt>
  40163f:	48 8b 44 24 68       	mov    0x68(%rsp),%rax              # +0x7b
